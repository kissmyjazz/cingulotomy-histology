---
title: "Visualisation of cingulotomy cell counts"
output:
  html_document:
    df_print: paged
---
...
**Figure 1**. Proportion of astrocytes to the sum of astrocytes and neurons in different brain regions. The observations are taken from three separate sections for each animal (when possible) and are ordered by median value within each ROI.
```{r astro-consistency}
